class PTP4LStatusParser:
    ...
    def get_output_values_dict(self) -> dict[str, dict[str, str]]:
        ...
        for line in self.ptp4l_status_output:
            line = line.strip()
            if "@" in line and ".service" in line and " - " in line:  # service header line (e.g. ● ptp4l@ptp1.service - Precision Time Protocol)
                service_name = line.split("@")[1].split(".service")[0]
