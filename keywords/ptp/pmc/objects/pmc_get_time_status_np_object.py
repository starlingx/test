class PMCGetTimeStatusNpObject:
    ...
    def set_master_offset(self, master_offset: int):
        ...
        Args:
            master_offset(int) : the master offset value
        """
    ...
    def set_ingress_time(self, ingress_time: int):
        ...
        Args:
            ingress_time(int) : the ingress time value
        """
    ...
    def get_cumulative_scaled_rate_offset(self) -> str:
        ...
        Returns:
            str: the cumulative scaled rate offset
        """
    ...
    def set_cumulative_scaled_rate_offset(self, cumulative_scaled_rate_offset: str):
        ...
        Args:
            cumulative_scaled_rate_offset(str) : the cumulative scaled rate offset value
        """
    ...
    def get_scaled_last_gm_phase_change(self) -> int:
        ...
        Returns:
            int: the scaled last GM phase change
        """
    ...
    def set_scaled_last_gm_phase_change(self, scaled_last_gm_phase_change: int):
        ...
        Args:
            scaled_last_gm_phase_change(int) : the scaled last GM phase change value
        """
    ...
    def get_gm_time_base_indicator(self) -> int:
        ...
        Returns:
            int: the GM time base indicator value
        """
    ...
    def set_gm_time_base_indicator(self, gm_time_base_indicator: int):
        ...
        Args:
            gm_time_base_indicator(int) : the GM time base indicator value
        """
    ...
    def get_last_gm_phase_change(self) -> str:
        ...
        Returns:
            str: the last GM phase change value
        """
    ...
    def set_last_gm_phase_change(self, last_gm_phase_change: str):
        ...
        Args:
            last_gm_phase_change(str) : the last GM phase change value
        """
        self.last_gm_phase_change = last_gm_phase_change

    def get_gm_present(self) -> bool:
    ...
    def set_gm_present(self, gm_present: bool):
        """Setter for GM presence.

        Args:
            gm_present(bool): the GM present value
        """
    ...
    def set_gm_identity(self, gm_identity: str):
        ...
        Args:
            gm_identity(str): the GM identity value
        """
