...
class DcManagerSubcloudListKeywords(BaseKeyword):
    ...
    def validate_subcloud_status(self, subcloud_name: str, status: str) -> bool:
        ...
        """
        failed_status = ["bootstrap-failed", "install-failed", "create-failed", "config-failed", "pre-enroll-failed", "enroll-failed", "pre-init-enroll-failed", "init-enroll-failed", "rehome-failed"]
        time_out = 4800
