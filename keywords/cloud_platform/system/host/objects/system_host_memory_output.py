...
from keywords.cloud_platform.system.host.objects.system_host_memory_object import (
    SystemHostMemoryObject,
)
...
class SystemHostMemoryOutput:
    ...
    def __init__(self, system_host_memory_output: str):
        """
        Constructor

        Args:
            system_host_memory_output (str): String output of 'system host-memory-list' command
        """
        ...
        for value in memory:
            ...
            if "mem_platform(MiB)" in value:
                ...
                if value["platform_reserved_mib"] and value["platform_reserved_mib"] != "None":
    ...
    def has_page_size_1gb(self) -> bool:
        """
        This function will look for a processor in the list of processors that has memory HugePage enabled 1 GB.
