...
class SystemHostStorageOutput:
    ...
    def __init__(self, system_host_stor_output):
        """
        Constructor

        Args:
            system_host_stor_output: String output of 'system host-stor-list' command
        """
    ...
    def get_osd_storage_count(self) -> int:
        """
        This function counts the number of OSD storages on this host by counting the objects in the storage list where
        the 'function' is 'osd'.
