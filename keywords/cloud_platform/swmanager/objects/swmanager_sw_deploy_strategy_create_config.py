class SwManagerSwDeployStrategyCreateConfig:
    ...
    def __init__(self, release: str, delete: bool = False, snapshot: bool = False, rollback: bool = False, controller_apply_type: str = None, storage_apply_type: str = None, worker_apply_type: str = None, instance_action: str = None, alarm_restrictions: str = None, max_parallel_worker_hosts: int = None, kube_upgrade: str = None) -> None:
        ...
        Args:
            ...
            kube_upgrade (str): Target Kubernetes version for combined P&K upgrade (e.g., 'v1.29.2').
        """
        ...
        # Combined Platform & Kubernetes upgrade
        self.kube_upgrade = kube_upgrade  # Target K8s version for combined upgrade
    ...
    def build_command_args(self) -> str:
        ...
        # Combined P&K upgrade - add target K8s version if specified
        if self.kube_upgrade:
            args.append(f"--kube-upgrade {self.kube_upgrade}")
