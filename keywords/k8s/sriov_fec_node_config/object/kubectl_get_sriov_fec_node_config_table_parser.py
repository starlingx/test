...
class KubectlGetSriovFecNodeConfigTableParser(K8sTableParserBase):
    """Class for parsing the output of 'kubectl get sriovfecnodeconfigs.sriovfec.intel.com' commands."""
