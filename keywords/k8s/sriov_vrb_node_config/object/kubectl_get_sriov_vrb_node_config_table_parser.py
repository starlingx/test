...
class KubectlGetSriovVrbNodeConfigTableParser(K8sTableParserBase):
    """Class for parsing the output of 'kubectl get sriovvrbnodeconfigs.sriovvrb.intel.com' commands."""
