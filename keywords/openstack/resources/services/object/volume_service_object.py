"""Volume service object representation."""


class VolumeServiceObject:
    """Represents a single Cinder volume service."""

    def __init__(self) -> None:
        """Initialize an empty VolumeServiceObject."""
        self._binary = ""
        self._host = ""
        self._zone = ""
        self._status = ""
    ...
    def get_binary(self) -> str:
        ...
        Returns:
            str: Service binary (e.g. 'cinder-scheduler', 'cinder-volume').
        """
        return self._binary
    ...
    def get_host(self) -> str:
        ...
        Returns:
            str: Host name (e.g. 'controller-0', 'controller-0@ceph').
        """
        return self._host
    ...
    def __str__(self) -> str:
        ...
        """
        return (
            f"VolumeServiceObject(binary={self._binary}, host={self._host}, "
