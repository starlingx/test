...
class TopBarRegion(baseregion.BaseRegion):
    ...
    def user_dropdown_menu(self):
        ...
        return menus.UserDropDownMenuRegion(self.driver, src_elem)
    ...
    def user_dropdown_project(self):
        ...
        return menus.ProjectDropDownRegion(self.driver, src_elem)
