...
class RestClient:
    ...
    def post(self, url: str, data: dict | str | None = None, headers: dict | list | None = None, cert: tuple[str, str] | None = None) -> RestResponse:
        ...
        """
        response = requests.post(url, headers=headers, data=data, verify=False, cert=cert)
        return RestResponse(response)

    def delete(self, url: str, headers: dict | None = None, cert: tuple[str, str] | None = None) -> RestResponse:
        """
        ...
        """
        response = requests.delete(url, headers=headers, verify=False, cert=cert)
        return RestResponse(response)

    def patch(self, url: str, data: dict | str | None = None, headers: dict | None = None, cert: tuple[str, str] | None = None) -> RestResponse:
        """
        ...
        """
        response = requests.patch(url, headers=headers, json=data, verify=False, cert=cert)
        return RestResponse(response)

    def put(self, url: str, data: dict | str | None = None, headers: dict | None = None, cert: tuple[str, str] | None = None) -> RestResponse:
        """
        ...
        """
        response = requests.put(url, headers=headers, json=data, verify=False, cert=cert)
        return RestResponse(response)
