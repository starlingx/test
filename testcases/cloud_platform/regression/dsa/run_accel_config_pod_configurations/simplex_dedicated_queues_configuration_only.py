...
@mark.lab_has_dsa
@mark.lab_is_simplex
def test_dsa_accel_config_pod_dedicated_queues_only_simplex(request):
    """Test case to install and validate Intel DSA plugin with dedicated queues only on simplex lab.
    ...
    **Test Steps**
    ...
    6. Verify DSA queues configuration (dedicated queues only).
    ...
    validate_equals(shared_total, 0, "Only dedicated queues remain after override")
