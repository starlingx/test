...
@mark.lab_has_dsa
@mark.lab_is_simplex
def test_dsa_accel_config_pod_shared_and_dedicated_queues_simplex(request):
    """Test case to install and validate Intel DSA plugin with shared and dedicated queues on simplex lab.

    **Requirements**
    - Lab hardware must support DSA.
    - Lab must be configured as simplex.
    ...
    **Test Steps**
    ...
    6. Verify DSA queues configuration (both shared and dedicated queues).
    ...
    11. Delete shared pod and upload the dedicated pod.
    ...
    node = nodes_json.get_node_objects()[0]
    ...
    node_after = nodes_json_after.get_node_objects()[0]
    ...
    validate_not_equals(shared_total, 0, "Shared queues available after override")

    dedicated_total = nodes_json_after.count_resource_total("dsa.intel.com/wq-user-dedicated")
    validate_not_equals(dedicated_total, 0, "Dedicated queues available after override")
