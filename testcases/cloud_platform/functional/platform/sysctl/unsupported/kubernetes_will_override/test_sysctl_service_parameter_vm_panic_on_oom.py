"""Tests that the unsupported sysctl parameter "vm.panic_on_oom" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.panic_on_oom", value="0", modified_value="0")
