"""Tests that the unsupported sysctl parameter "kernel.panic_on_oops" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.panic_on_oops", value="1", modified_value="1")
