"""Tests that the unsupported sysctl parameter "kernel.panic" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.panic", value="0", modified_value="0")
