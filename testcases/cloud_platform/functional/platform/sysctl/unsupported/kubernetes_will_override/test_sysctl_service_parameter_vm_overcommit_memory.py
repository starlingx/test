"""Tests that the unsupported sysctl parameter "vm.overcommit_memory" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.overcommit_memory", value="0", modified_value="0")
