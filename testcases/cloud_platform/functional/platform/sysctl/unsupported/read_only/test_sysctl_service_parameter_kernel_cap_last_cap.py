"""Tests that the unsupported sysctl parameter "kernel.cap_last_cap" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.cap_last_cap", value="40", modified_value="40")
