"""Tests that the unsupported sysctl parameter "kernel.bootloader_type" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.bootloader_type", value="114", modified_value="114")
