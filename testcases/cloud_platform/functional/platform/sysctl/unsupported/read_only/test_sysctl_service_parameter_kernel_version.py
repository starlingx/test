"""Tests that the unsupported sysctl parameter "kernel.version" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.version", value="#1 SMP", modified_value="#1 SMP")
