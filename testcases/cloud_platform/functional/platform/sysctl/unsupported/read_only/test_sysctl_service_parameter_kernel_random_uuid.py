"""Tests that the unsupported sysctl parameter "kernel.random.uuid" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.random.uuid", value="12345678-1234-1234-1234-123456789012", modified_value="12345678-1234-1234-1234-123456789012")
