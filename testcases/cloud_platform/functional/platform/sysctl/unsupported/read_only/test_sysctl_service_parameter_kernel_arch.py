"""Tests that the unsupported sysctl parameter "kernel.arch" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.arch", value="x86_64", modified_value="x86_64")
