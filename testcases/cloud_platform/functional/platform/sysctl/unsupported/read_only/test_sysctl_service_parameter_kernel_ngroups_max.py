"""Tests that the unsupported sysctl parameter "kernel.ngroups_max" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.ngroups_max", value="65536", modified_value="65536")
