"""Tests that the unsupported sysctl parameter "kernel.random.entropy_avail" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.random.entropy_avail", value="256", modified_value="256")
