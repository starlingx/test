"""Tests that the unsupported sysctl parameter "kernel.osrelease" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.osrelease", value="5.10.0", modified_value="5.10.0")
