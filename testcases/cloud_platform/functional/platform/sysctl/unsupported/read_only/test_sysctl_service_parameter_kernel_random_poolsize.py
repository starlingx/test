"""Tests that the unsupported sysctl parameter "kernel.random.poolsize" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.random.poolsize", value="4096", modified_value="4096")
