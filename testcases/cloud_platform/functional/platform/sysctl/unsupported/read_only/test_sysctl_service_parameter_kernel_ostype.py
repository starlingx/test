"""Tests that the unsupported sysctl parameter "kernel.ostype" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.ostype", value="Linux", modified_value="Linux")
