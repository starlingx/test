"""Tests that the unsupported sysctl parameter "kernel.modules_disabled" cannot be added or modified.

This parameter is considered dangerous or unsafe to modify.
"""
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.modules_disabled", value="0", modified_value="0")
