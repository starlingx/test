"""Tests that the unsupported sysctl parameter "kernel.sysrq" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.sysrq", value="16", modified_value="16")
