"""Tests that the unsupported sysctl parameter "vm.compact_memory" cannot be added or modified.

This is a write-only kernel parameter that triggers an action.
"""
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.compact_memory", value="1", modified_value="1")
