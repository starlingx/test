"""Tests that the unsupported sysctl parameter "vm.drop_caches" cannot be added or modified.
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.drop_caches", value="0", modified_value="0")
