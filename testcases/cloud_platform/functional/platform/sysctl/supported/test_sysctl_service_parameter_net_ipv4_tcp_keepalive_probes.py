"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_keepalive_probes".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_keepalive_probes", value="10", modified_value="15")
