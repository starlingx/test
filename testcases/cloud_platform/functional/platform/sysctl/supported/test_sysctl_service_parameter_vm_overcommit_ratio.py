"""Tests adding and modifying the supported sysctl parameter "vm.overcommit_ratio".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.overcommit_ratio", value="50", modified_value="75")
