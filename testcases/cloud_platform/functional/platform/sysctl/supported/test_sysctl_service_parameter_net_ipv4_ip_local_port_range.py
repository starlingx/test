"""Tests adding and modifying the supported sysctl parameter "net.ipv4.ip_local_port_range".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.ip_local_port_range", value="10240 65535", modified_value="20480 65535")
