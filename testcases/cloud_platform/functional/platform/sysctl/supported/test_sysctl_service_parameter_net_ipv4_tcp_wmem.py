"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_wmem".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_wmem", value="4096 65536 16777216", modified_value="8192 131072 33554432")
