"""Tests adding and modifying the supported sysctl parameter "net.ipv4.neigh.default.gc_thresh2".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.neigh.default.gc_thresh2", value="2048", modified_value="4096")
