"""Tests adding and modifying the supported sysctl parameter "fs.inotify.max_user_instances".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="fs.inotify.max_user_instances", value="512", modified_value="1024")
