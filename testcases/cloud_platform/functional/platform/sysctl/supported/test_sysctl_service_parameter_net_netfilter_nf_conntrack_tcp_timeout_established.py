"""Tests adding and modifying the supported sysctl parameter "net.netfilter.nf_conntrack_tcp_timeout_established".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.netfilter.nf_conntrack_tcp_timeout_established", value="86400", modified_value="172800")
