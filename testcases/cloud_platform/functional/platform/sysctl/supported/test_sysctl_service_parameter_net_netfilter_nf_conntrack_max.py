"""Tests adding and modifying the supported sysctl parameter "net.netfilter.nf_conntrack_max".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.netfilter.nf_conntrack_max", value="2000000", modified_value="4000000")
