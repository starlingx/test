"""Tests adding and modifying the supported sysctl parameter "vm.min_free_kbytes".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.min_free_kbytes", value="65536", modified_value="131072")
