"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_mtu_probing".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_mtu_probing", value="1", modified_value="2")
