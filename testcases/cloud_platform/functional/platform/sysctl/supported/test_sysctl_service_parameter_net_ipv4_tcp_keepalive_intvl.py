"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_keepalive_intvl".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_keepalive_intvl", value="30", modified_value="60")
