"""Tests adding and modifying the supported sysctl parameter "vm.vfs_cache_pressure".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.vfs_cache_pressure", value="50", modified_value="100")
