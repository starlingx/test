"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_rmem".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_rmem", value="4096 87380 16777216", modified_value="8192 131072 33554432")
