"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_slow_start_after_idle".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_slow_start_after_idle", value="0", modified_value="1")
