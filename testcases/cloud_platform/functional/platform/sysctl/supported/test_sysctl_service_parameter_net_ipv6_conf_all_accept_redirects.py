"""Tests adding and modifying the supported sysctl parameter "net.ipv6.conf.all.accept_redirects".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv6.conf.all.accept_redirects", value="0", modified_value="1")
