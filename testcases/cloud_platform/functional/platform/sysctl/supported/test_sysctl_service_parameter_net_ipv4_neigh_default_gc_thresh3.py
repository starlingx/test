"""Tests adding and modifying the supported sysctl parameter "net.ipv4.neigh.default.gc_thresh3".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.neigh.default.gc_thresh3", value="4096", modified_value="8192")
