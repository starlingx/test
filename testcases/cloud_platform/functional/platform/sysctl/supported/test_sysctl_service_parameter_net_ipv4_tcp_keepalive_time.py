"""Tests adding and modifying the supported sysctl parameter "net.ipv4.tcp_keepalive_time".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.tcp_keepalive_time", value="600", modified_value="1200")
