"""Tests adding and modifying the supported sysctl parameter "fs.aio-max-nr".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="fs.aio-max-nr", value="1048576", modified_value="2097152")
