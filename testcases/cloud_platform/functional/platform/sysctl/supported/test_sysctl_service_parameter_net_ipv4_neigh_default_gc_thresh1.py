"""Tests adding and modifying the supported sysctl parameter "net.ipv4.neigh.default.gc_thresh1".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="net.ipv4.neigh.default.gc_thresh1", value="1024", modified_value="2048")
