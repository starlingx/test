"""Tests adding and modifying the supported sysctl parameter "fs.protected_hardlinks".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="fs.protected_hardlinks", value="1", modified_value="0")
