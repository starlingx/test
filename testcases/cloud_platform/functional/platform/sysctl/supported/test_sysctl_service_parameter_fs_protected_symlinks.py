"""Tests adding and modifying the supported sysctl parameter "fs.protected_symlinks".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="fs.protected_symlinks", value="1", modified_value="0")
