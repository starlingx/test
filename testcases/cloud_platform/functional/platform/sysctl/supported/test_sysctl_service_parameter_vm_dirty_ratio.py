"""Tests adding and modifying the supported sysctl parameter "vm.dirty_ratio".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="vm.dirty_ratio", value="15", modified_value="20")
