"""Tests adding and modifying the supported sysctl parameter "fs.inotify.max_user_watches".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="fs.inotify.max_user_watches", value="524288", modified_value="1048576")
