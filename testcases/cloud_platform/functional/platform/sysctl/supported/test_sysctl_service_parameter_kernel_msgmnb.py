"""Tests adding and modifying the supported sysctl parameter "kernel.msgmnb".
...
TEST_PARAMETER = SystemServiceParameterObject(service=CONST.SERVICE, section=CONST.SECTION, name="kernel.msgmnb", value="65536", modified_value="131072")
